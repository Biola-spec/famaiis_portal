...
<div class="row"> <!-- 6th Row -->
		...
		<div class="controls">
	 <input type="text" name="nin" class="form-control" required="" value="{{ $editData['student']['nin'] }}"> 
	  </div>		 
	  </div>
	...
	<div class="col-md-4">
		...
		<div class="controls">
	 <input type="text" name="state" class="form-control" required="" value="{{ $editData['student']['state'] }}"> 
	  </div>		 
	  </div>
	...
	<div class="col-md-4">
		...
		<div class="controls">
	 <input type="text" name="lga" class="form-control" required="" value="{{ $editData['student']['lga'] }}"> 
	  </div>		 
	  </div>
