...
<script type="text/javascript">
	$(document).ready(function(){
        ...
        function updateStates(country, isInitial) {
            ...
            if (locationsData[country]) {
                ...
                if(isInitial && savedState) {
                    updateLgas(country, savedState, true);
                }
            }
        }

        function updateLgas(country, state, isInitial) {
            const lgaSelect = $('#lga_id');
        ...
        $('#country_id').on('change', function(e, isInitial) {
            updateStates($(this).val(), isInitial);
        });

        $('#state_id').on('change', function(e, isInitial) {
            updateLgas($('#country_id').val(), $(this).val(), isInitial);
        });

        // Trigger initial load if country is selected
        if($('#country_id').val()) {
            updateStates($('#country_id').val(), true);
        }
