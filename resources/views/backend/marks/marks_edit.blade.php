...
<div class="col-md-3">
 ...
 <select name="term" id="term"  required="" class="form-control">
			...
			<option value="3rd Term">3rd Term</option>
 			...
 			<div class="col-md-2"  >
  <a id="search" class="btn btn-primary" style="margin-top:25px;" name="search"> Search</a>
 			</div> <!-- End Col md 2 --> 
...
<script type="text/javascript">
  $(document).on('click','#search',function(){
    ...
    var term = $('#term').val();
    if(!year_id || !class_id || !assign_subject_id || !term){
     ...
     $.ajax({
      ...
      type: "GET",
      data: {'year_id':year_id,'class_id':class_id,'assign_subject_id':assign_subject_id,'term':term},
      success: function (data) {
        $('#marks-entry').removeClass('d-none');
        var html = '';
        if(data.length == 0){
            html = '<tr><td colspan="5" class="text-center text-danger">No marks found for the selected criteria. Ensure you have already entered marks for this term.</td></tr>';
