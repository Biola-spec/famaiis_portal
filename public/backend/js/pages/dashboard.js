...
$(function () {
  ...
  function renderChart(selector, options) {
	...
	var options = {
      ...
      renderChart("#charts_widget_43_chart", options);
	...
	var options = {
        ...
        renderChart("#recent_trend", options);
